...
public class TestList {
  ...
  public void testContainsAll() {
    ...
    assertTrue(list.containsAll(b));
    Integer[] elements = new Integer[] {11, 22, 33};
    List c = new ArrayList<Integer>(Arrays.asList(elements));
    assertFalse(list.containsAll(c));
  }

  @Test
  public void testAddAll() {
    Integer[] a = new Integer[] {33, 77, 44, 77, 55, 77, 66};
  ...
  public void testRemoveAll() {
    ...
    list.add(77);
    list.add(66);
    Integer[] a = new Integer[] {33, 44, 55, 66};
  ...
  public void testRetainAll() {
    ...
    list.add(77);
    list.add(66);
    Integer[] a = new Integer[] {77, 77, 77};
